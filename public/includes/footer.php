<footer class="bg-brand-black text-white pt-12 lg:pt-20 pb-24 lg:pb-10 border-t border-white/5">
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-16">
            ...
            <div>
                <h2 class="font-black text-[10px] uppercase tracking-[0.3em] text-brand-cyan mb-6">Navegación</h2>
            ...
            <div>
                <h2 class="font-black text-[10px] uppercase tracking-[0.3em] text-brand-cyan mb-6">Legal y Ayuda</h2>
                <ul class="space-y-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">
            ...
            <div>
                <h2 class="font-black text-[10px] uppercase tracking-[0.3em] text-brand-cyan mb-6">Contacto Oficial</h2>
                <div class="space-y-4">
